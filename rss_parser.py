...
def extract_podcast_data_from_content(episode,
                                      model_name: str = "gpt-4-0125-preview") -> str:
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Extract per-episode speakers and fields of discussion from RSS feeds.')
